...
// import { AutocompleteInput } from "@engie-group/fluid-design-system";
...
export class AutoComplete<T> extends View<Props<T>> {
  override template() {
    return html`<div
      class="nj-form-item nj-form-item--autocomplete nj-form-item--static"
      ...
      data-options='{"noResultMessage":"No results","singularResultsMessage":"{x} result","pluralResultsMessage":"{x} results","showResultNumber":true,"limit":10}'
    >
      <div class="nj-form-item__field-wrapper">
        <input
          class="nj-form-item__field"
          id="exampleAutocompleteStatic"
          placeholder="Example"
          role="combobox"
          aria-autocomplete="list"
          aria-controls="countries-static"
          aria-expanded="false"
          autocomplete="off"
        />
        <label for="exampleAutocompleteStatic" class="nj-form-item__label">
        ...
        <ul
          ...
          id="countries-static"
          tabindex="-1"
          aria-label="Countries suggestions"
          hidden
        >
